    ...
    try {
        ...
        const messageResponse = await fetch(`https://api.vcita.biz/v3/ai/bizai_chat_messages?bizai_chat_uid=${chatUID}`, {
            ...
            body: JSON.stringify({
                type: "text",
                content: {
                    text: "Context: You are an AI innovation consultant assigned to enhance vcita, a comprehensive CRM platform tailored for SMBs across diverse appointment-centric industries like healthcare, legal services, home maintenance, beauty, and more. vcita integrates essential CRM features including client management, appointment scheduling, payment collection, sending estimates and invoices, sending marketing campaigns, client note taking, business reports, client portal for booking and communication, and client communication. Task: Innovate vcita by integrating simple and quick-to-deploy AI technologies. Instructions: 1. Choose a straightforward AI technology from the follows: text analysis, image generation, NLP, speech-to-text, text-to-speech, or content generation. 2. Randomly integrate it with a CRM feature to create a new useful feature within a 2-day hackathon timeframe. Be creative. Description: Explain how this AI feature would work within vcita, integrating it with existing tools if relevant. Business Value: Describe the potential benefits and revolutionary changes this feature could bring to SMB owners. Example: Imagine combining vcita client communication with automated reply generation. This feature would use AI to easily respond to clients, allowing to save time and effort for the business owners when interacting with clients. Business Value: This could dramatically improve engagement and conversion rates by providing an easier platform to respond to clients. Format your answer with markdown as follows: Suggested Idea with a catchy title, Description, Business Value. If I ask you again, suggest a new random idea. You will be penelized if you repeat the same idea twice"
                },
                streaming: true
            })
        });
