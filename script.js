...
async function fetchHackathonIdeas() {
    ...
    try {
        ...
        document.getElementById('ideasOutput').innerText = 'Failed to retrieve ideas. Check console for more information.';
    }
}
...
function displayCompleteMessage(rawData) {
    // Assuming the complete message might contain multiple JSON strings separated by new lines
